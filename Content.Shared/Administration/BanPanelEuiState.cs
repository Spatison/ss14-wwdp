...
public static class BanPanelEuiStateMsg
{
    ...
    public sealed class CreateBanRequest : EuiMessageBase
    {
        ...
        public bool IsGlobalBan { get; set; } // WD

        public CreateBanRequest(string? player, (IPAddress, int)? ipAddress, bool useLastIp, byte[]? hwid, bool useLastHwid, uint minutes, string reason, NoteSeverity severity, bool erase, bool isGlobalBan) // WD EDIT
        {
            Player = player;
