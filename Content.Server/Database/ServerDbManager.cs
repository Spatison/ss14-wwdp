...
namespace Content.Server.Database
{
    ...
    {
        const string GlobalServerName = "unknown"; // WD
        void Init();
    ...
    {
        private const string GlobalServerName = "unknown"; // WD
        ...
        {
            DbReadOpsMetric.Inc();
            return RunDbCommand(() => _db.GetServerBanAsync(address, userId, hwId, serverName)); // WD EDIT
        }
        ...
        public Task<List<ServerBanDef>> GetServerBansAsync(
            ...
            ImmutableArray<byte>? hwId,
            bool includeUnbanned=true,
            string serverName = GlobalServerName) // WD EIT
        {
            DbReadOpsMetric.Inc();
            return RunDbCommand(() => _db.GetServerBansAsync(address, userId, hwId, includeUnbanned, serverName)); // WD EDIT
        }
