...
public sealed partial class TTSSystem
{
    ...
    /*[GeneratedRegex("[a-zA-Z]", RegexOptions.IgnoreCase | RegexOptions.Multiline, "en-US")]
    ...
    private static string Sanitize(string text)
    {
        ...
        // text = LatinRegex().Replace(text, ReplaceLat2Cyr);
    ...
    /*private static readonly Dictionary<string, string> ReverseTranslit = new()
    {
        { "a", "а" },
        { "b", "б" },
        { "v", "в" },
...
public static class NumberConverter
{
    ...
    private static long AppendPeriod(long value, long power, StringBuilder str, string declension1, string declension2,
        string declension5, bool male)
    {
    ...
    private static string NumberToText(long value, bool male, string valueDeclensionFor1, string valueDeclensionFor2,
        string valueDeclensionFor5)
    {
        return NumberToText(value, male) + " " + GetDeclension((int) (value % 10), valueDeclensionFor1,
            valueDeclensionFor2, valueDeclensionFor5);
    }
