...
namespace Content.Client.Administration.UI
{
    ...
    public sealed class PermissionsEui : BaseEui
    {
        ...
        private void SaveAdminPressed(EditAdminWindow popup)
        {
            ...
            var adminServer = string.IsNullOrWhiteSpace(popup.ServerNameEdit.Text) ? "unknown" : popup.ServerNameEdit.Text; // WD
        ...
        private sealed class EditAdminWindow : DefaultWindow
        {
            ...
            public readonly LineEdit ServerNameEdit; // WD
            ...
            public EditAdminWindow(PermissionsEui ui, PermissionsEuiState.AdminData? data)
            {
                ...
                ServerNameEdit = new LineEdit { PlaceHolder = Loc.GetString("permissions-eui-edit-admin-window-server-edit-placeholder") }; // WD
