...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class AudioTab : Control
    {
        ...
        public AudioTab()
        {
            ...
            TtsVolumeSlider.OnValueChanged += OnTtsVolumeSliderChanged; // White Dream
        ...
        private void OnApplyButtonPressed(BaseButton.ButtonEventArgs args)
        {
            ...
            _cfg.SetCVar(WhiteCVars.TtsVolume, TtsVolumeSlider.Value  / 100f * ContentAudioSystem.TTSMultiplier); // White Dream
        ...
        private void Reset()
        {
            ...
            TtsVolumeSlider.Value = _cfg.GetCVar(WhiteCVars.TtsVolume) * 100f / ContentAudioSystem.TTSMultiplier; // White Dream
